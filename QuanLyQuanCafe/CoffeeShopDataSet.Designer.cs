...
namespace QuanLyQuanCafe {
    ...
    public partial class CoffeeShopDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductRow AddProductRow(string id, string name, double purchasePrice, double sellingPrice, ProductCategoryRow parentProductCategoryRowByFK_PRODUCTCATEGORY_PRODUCT) {
...
namespace QuanLyQuanCafe.CoffeeShopDataSetTableAdapters {
...
SELECT orderId, productId, quantity FROM OrderItem WHERE (orderId = @orderId) AND (productId = @productId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QuanLyQuanCafe.Properties.Settings.Default.CoffeeShopConnectionString;
        }
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Product] WHERE (([id] = @Original_id) AND ([name] = @Original_" +
                "name) AND ([purchasePrice] = @Original_purchasePrice) AND ([sellingPrice] = @Ori" +
                "ginal_sellingPrice) AND ([categoryId] = @Original_categoryId))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Product] ([id], [name], [purchasePrice], [sellingPrice], [cate" +
                "goryId]) VALUES (@id, @name, @purchasePrice, @sellingPrice, @categoryId);\r\nSELEC" +
                "T id, name, purchasePrice, sellingPrice, categoryId FROM Product WHERE (id = @id" +
                ")";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [id] = @id, [name] = @name, [purchasePrice] = @purchasePrice, [sellingPrice] = @sellingPrice, [categoryId] = @categoryId WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([purchasePrice] = @Original_purchasePrice) AND ([sellingPrice] = @Original_sellingPrice) AND ([categoryId] = @Original_categoryId));
SELECT id, name, purchasePrice, sellingPrice, categoryId FROM Product WHERE (id = @id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, name, purchasePrice, sellingPrice, categoryId FROM dbo.Product";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(string Original_id, string Original_name, double Original_purchasePrice, double Original_sellingPrice, int Original_categoryId) {
            if ((Original_id == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string id, string name, double purchasePrice, double sellingPrice, int categoryId) {
            if ((id == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string id, string name, double purchasePrice, double sellingPrice, int categoryId, string Original_id, string Original_name, double Original_purchasePrice, double Original_sellingPrice, int Original_categoryId) {
            if ((id == null)) {
                throw new global::System.ArgumentNullException("id");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((double)(Original_sellingPrice));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, double purchasePrice, double sellingPrice, int categoryId, string Original_id, string Original_name, double Original_purchasePrice, double Original_sellingPrice, int Original_categoryId) {
            return this.Update(Original_id, name, purchasePrice, sellingPrice, categoryId, Original_id, Original_name, Original_purchasePrice, Original_sellingPrice, Original_categoryId);
        }
    }
